...
export const KEY_HELP: KeyDesc[] = [
  ...
  { group: "Prompt", keys: ["Esc"], desc: "vim NORM mode (h/j/k/l move, dd delete line, x delete char, i/a/A insert, u undo, Ctrl+R redo)" },
  { group: "Prompt", keys: ["z"], desc: "NORM mode: fzf-style session switcher with live preview" },
  { group: "Prompt", keys: ["i / a / A"], desc: "Leave NORM mode, insert before / after / line end" },
  ...
  { group: "Session", keys: ["Ctrl+X"], desc: "Leader: n=new, l/r=recent sessions, e=editor, q=exit, y=copy, h=help (hint shown in prompt bar)" },
